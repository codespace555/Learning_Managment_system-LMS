...
function Navbar() {
  ...
  return (
    <>
      <nav className="w-screen glass fixed top-0 z-50 dark:text-gray-400">
        ...
        <div className="drawer-content flex flex-col">
          ...
          <div className="w-full navbarsticky top-0 z-50 backdrop-blur p-5 transition-colors duration-500 lg:z-50 lg:border-b lg:border-slate-900/10 dark:border-slate-50/[0.06] bg-gray-500 supports-backdrop-blur:bg-white/95 dark:bg-slate-900/75 justify-center items-center ">
            <div className="flex justify-around items-center w-full gap-x-4 align-middle">
              ...
              <div className=" md:flex bg-zinc-900 items-center  py-[10px] px-5  w-[70%] relative rounded-lg hidden lg:flex ">
                <svg
