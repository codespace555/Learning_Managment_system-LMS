        ...
        >
          ...
          <form onSubmit={handleSubmit()} className=" ">
            ...
            <div className="space-y-5">
              <div className="md:flex hidden  items-center justify-center md:h-auto h-20 w-full p-5">
                <label
                ...
                >
                  <div className="flex  flex-col items-center justify-center pt-5 pb-6 ">
                    ...
                    <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
                      <span className="font-semibold">Click to upload Avatar</span> or drag
                      and drop
                    </p>
              ...
              <label htmlFor="avtar">Add Avatar</label>
              <input type="file" className="file-input file-input-bordered w-full max-w-xs" placeholder="Add Avatar" id="avtar"/>
              </div>
